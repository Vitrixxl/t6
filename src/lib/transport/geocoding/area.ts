// Bornage géographique de la recherche : la plateforme sert une métropole, pas
// le monde entier. Filtrer côté client évite d'afficher des résultats hors
// périmètre que l'utilisateur ne pourrait de toute facon pas rejoindre.
