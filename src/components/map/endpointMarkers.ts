// Reperes de départ et d'arrivée.
//
// Un simple cercle colore ne se distinguait pas des centaines d'arrêts et de
// stations affiches sur la carte. Or ce sont les deux points que l'utilisateur
// vient de choisir : ils doivent se lire immédiatement, dès la sélection, sans
// attendre qu'un itinéraire soit calculé.
//
// D'où une épingle dessinée en SVG, ancrée par sa pointe sur la coordonnée, et
// accompagnée du nom du lieu. Marqueur HTML plutôt que couche `symbol` : le
...
/** Épingle en goutte : la pointe marque la coordonnée exacte. */
...
function createEndpoint(role: EndpointRole, point: GeoPoint): HTMLElement {
    ...
    // textContent, jamais innerHTML : le libellé vient d'un géocodeur tiers.
 ...
 * Les anciens sont retirés : sans cela, changer de départ empilerait les
 * epingles précédentes.
 */
